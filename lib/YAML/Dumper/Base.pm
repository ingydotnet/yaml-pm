die "NOTICE: YAML::Dumper::Base has been moved to YAML::Old::Dumper::Base.
...
YAML::Dumper::Base - Deprecated

=head1 DESCRIPTION

The original L<YAML> distribution has been replaced by L<YAML-Old>.

C<YAML::Dumper::Base> has been moved to L<YAML::Old::Dumper::Base>.
